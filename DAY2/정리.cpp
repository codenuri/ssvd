...
// => thread_local 개념 - 스레드당 한개의 static storage 개념
// => 뮤텍스 6가지 종류
// => lock management : lock_guard, unique_lock, shared_lock, scoped_lock
// => std::condition_variable
// => std::semaphore, std::latch, std::barrier => C++20 에서 추가된 간단한 도구
// => thread pool 만들기 예제.. - "다양한 스레드 기술 + C++ 문법 활용"
